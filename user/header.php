...
<style>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="../userdashboard.php" style="color:white;">Dashboard <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item dropdown">
        ...
        <a class="dropdown-item" href="pending1.php">Pendindg Rides</a>
          <a class="dropdown-item" href="completed.php">Completed Rides</a>
