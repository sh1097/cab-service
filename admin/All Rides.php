...
<?php $results = mysqli_query($con, "SELECT * FROM tbl_ride "); ?>
...
<thead>
        ...
        <td><a href="invoice.php?dummy=<?php echo $row['Ride_id'];?>"><button type="button" class="btn btn-success" 
                 style="font-size:13px;">Invoice</button>
                 </td>
